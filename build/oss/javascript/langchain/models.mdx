...
<ParamField body="maxRetries" type="number" default="6">
    ...
    On providers that support it, [model retry middleware](/oss/javascript/langchain/middleware/built-in#model-retry) takes over retries for the calls it wraps, and this value does not apply to them.
</ParamField>
